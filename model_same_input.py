...
for i in range(25):
    ...
    state_output_for_1, action_output_for_1, next_state_output_for_1 = models[i](input_for_25_nets)

    outputs_for_25_nets.append(state_output_for_1)
    outputs_for_25_nets.append(action_output_for_1)
    outputs_for_25_nets.append(next_state_output_for_1)
...
# plot_model(model_for_25_nets, to_file='model_for_25_nets.png',show_shapes = True, show_layer_names = True)
