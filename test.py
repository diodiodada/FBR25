...
F_dense_s_1 = Dense(50, activation='relu', name='F_dense_s_1')(F_STATE_T)
...
F_dense_a_1 = Dense(50, activation='relu', name='F_dense_a_1')(F_ACTION_T)
...
next_state_output = Dense(17, name='next_state_output')(F_input_4)
...
B_dense_s_1 = Dense(50, activation='relu', name='B_dense_s_1')(B_STATE_T)
...
B_dense_a_1 = Dense(50, activation='relu', name='B_dense_a_1')(B_ACTION_T)
...
action_output = Dense(6, name='action_output')(B_input_4)
...
R_dense_s_1 = Dense(50, activation='relu', name='R_dense_s_1')(R_STATE_T)
...
R_dense_a_1 = Dense(50, activation='relu', name='R_dense_a_1')(R_ACTION_T)
...
state_output = Dense(17, name='state_output')(R_input_4)


#============================================================================

model = Model(inputs=[state,action,next_state], outputs=[state_output,action_output,next_state_output], name = 'only_model')
